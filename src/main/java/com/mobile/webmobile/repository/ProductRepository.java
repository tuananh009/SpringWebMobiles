package com.mobile.webmobile.repository;

import com.mobile.webmobile.entity.Product;
import com.mobile.webmobile.model.dto.ChartDTO;
...
//    @Query(value = "SELECT NEW com.mobile.webmobile.model.dto.ProductInfoDTO(p.id, p.name, p.slug, p.price ,p.images ->> '$[0]', p.total_sold) " +
//            "FROM product p " +
//            "WHERE p.status = 1 " +
